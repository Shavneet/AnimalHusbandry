...
import com.animalhusbandry.petprofile.UpdatePetProfileActivity;
...
public class AdapterUserPetProfiles extends RecyclerView.Adapter<AdapterUserPetProfiles.ViewHolder> {
    public CardView cardView;
    private Activity activity;
    private ArrayList<GetPetProfilesOfUserResponse.Result> userPetArrayList;

    public AdapterUserPetProfiles(Activity activity, ArrayList<GetPetProfilesOfUserResponse.Result> userPetArrayList) {
        this.activity = activity;
        this.userPetArrayList = userPetArrayList;
    }

    @Override
    public AdapterUserPetProfiles.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pet_list_user_card_view, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdapterUserPetProfiles.ViewHolder holder, int position) {
        ...
        public ViewHolder(final View itemView) {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(activity.getBaseContext(), UpdatePetProfileActivity.class);
                    Bundle bundle = new Bundle();
                    /*bundle.putSerializable("petVaccinationsListOfUser", result.getPetVaccinationsList());*/
                    bundle.putSerializable("petResultListOfUser", result);
